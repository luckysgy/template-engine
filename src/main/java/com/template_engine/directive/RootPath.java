...
public class RootPath extends Directive {
     ...
     * @return 相对于根路径的相对路径
     */
    public String rootPath(String absolutePath) {
        return FileUtils.returnRootPath(ApplicationContext.targetProjectRootPath, absolutePath);
    }
    ...
    public boolean render(InternalContextAdapter context, Writer writer, Node node) throws IOException, ResourceNotFoundException, ParseErrorException, MethodInvocationException {
        ...
        writer.write(rootPath(templatePath));
        return true;
    }
}
